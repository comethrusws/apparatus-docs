...
<Tabs>
  <TabItem value="curl" label="curl">
    ```bash
    curl -H "Authorization: Bearer apai_your_token_here" https://api.apparatusai.space/api/user/info
    ```
  </TabItem>
  <TabItem value="js" label="JavaScript">
    ```javascript
    import { ApparatusClient } from 'apparatus-sdk';
    
    // Initialize the client with your API key
    const client = new ApparatusClient('apai_your_token_here');
...
<Tabs>
  <TabItem value="curl" label="curl">
    ...
    curl -X POST \
      ...
      https://api.apparatusai.space/api/forecast
    ```
  </TabItem>
  <TabItem value="js" label="JavaScript">
    ```javascript
    ...
    async function generateForecast() {
      ...
      const forecast = await client.forecast.generate(forecastData);
  ...
  <TabItem value="py" label="Python">
    ...
    def generate_forecast():
        ...
        forecast = client.forecast.generate(forecast_data)
        print(forecast)
...
<Tabs>
  <TabItem value="curl" label="curl">
    ...
    curl -X POST \
      ...
      https://api.apparatusai.space/api/social-analysis
    ```
  </TabItem>
  <TabItem value="js" label="JavaScript">
    ```javascript
    ...
    async function analyzeSocialTrends() {
      ...
      const analysis = await client.social.analyze(analysisParams);
  ...
  <TabItem value="py" label="Python">
    ...
    def analyze_social_trends():
        ...
        analysis = client.social.analyze(analysis_params)
        print(analysis)
